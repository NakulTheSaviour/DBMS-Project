...
def customer_grant():       # grant permission defined in query1 and query2 to all the customers
    ...
    for x in cursor:
        try:
            ...
            query1 = query1 +"GRANT SELECT ON retail_store.categorization TO '"+str(x[0])+"'@'localhost'; "
            ...
            query2 = query2 + "GRANT SELECT ON retail_store.product TO '"+str(x[0])+"'@'localhost'; "
...
def supplier_grant():       # grant permission defined in query1 to all the suppliers
    ...
    for x in cursor:
        try:       
            ...
            query1 = query1 +"GRANT CREATE ANY VIEW TO '"+str(x[0])+"'@'localhost'; "
            ...
            query1 = query1 +"GRANT INSERT, UPDATE, DELETE, SELECT ON retail_store.supplies TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT INSERT, UPDATE, DELETE, SELECT ON retail_store.supplies_ordered TO '"+str(x[0])+"'@'localhost';"
            mydb1 = mysql.connector.connect(
                host='localhost', 
                user = 'root', 
                password = 'mohit20086',
...
def employee_grant():           # grant permission defined in query1 to all the employees
    ...
    for x in cursor:
        try:       
            ...
            query1 = query1 +"GRANT SELECT ON retail_store.address TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT SELECT ON retail_store.customer TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT SELECT ON retail_store.customer_login TO '"+str(x[0])+"'@'localhost'; "
            ...
            query1 = query1 +"GRANT SELECT ON retail_store.payment TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT SELECT ON retail_store.shipped_to TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT SELECT ON retail_store.manufactured_by TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT SELECT ON retail_store.manufacturer TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT SELECT ON retail_store.shipping_info TO '"+str(x[0])+"'@'localhost';"
            query1 = query1 +"GRANT SELECT ON retail_store.place_order TO '"+str(x[0])+"'@'localhost';"
            ...
            query1 = query1 +"GRANT INSERT, UPDATE, DELETE, SELECT ON retail_store.employee_"+str(x[2])+" TO '"+str(x[0])+"'@'localhost'; "
            query1 = query1 +"GRANT INSERT, UPDATE, DELETE, SELECT ON retail_store.employee_login_"+str(x[2])+" TO '"+str(x[0])+"'@'localhost'; "
